...
public class MessageController {
    ...
    @GetMapping("/contacts")
    public Map<String, Object> getContacts(@RequestParam Integer userId) {
        List<Object> contacts = userService.getContacts(userId);
        return Map.of("success", true, "data", contacts);
    }
}